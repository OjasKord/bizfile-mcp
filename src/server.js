...
const server = http.createServer(async (req, res) => {
  ...
  if (req.url === '/health' && req.method === 'GET') {
    ...
    res.end(JSON.stringify({ status: 'ok', version: '3.0.0', free_tier: 'no API key required for first 100 calls', paid_keys_issued: apiKeys.size }));
    return;
  }
